...
var DZ_SCHILD_SCREEN_CSS = [
    ...
    '.sp-spruch { writing-mode:vertical-rl; transform:rotate(180deg); display:flex; align-items:center; justify-content:center; font-family:Georgia,serif; font-style:italic; font-size:clamp(5px,.75vw,9.5px); color:#555; letter-spacing:.08em; padding-right:clamp(2px,.4vw,5px); white-space:nowrap; flex-shrink:0; border-right:1px solid #e0dbd4; margin-right:clamp(2px,.4vw,5px); }',
    ...
    '.sp-nfc { width:clamp(70px,13vw,148px); flex:1 1 0; border:1.5px dashed #ccc; border-radius:8px; overflow:hidden; display:flex; flex-direction:row; }',
    ...
    '.sp-right { display:flex; flex-direction:column; gap:clamp(4px,.7vw,8px); flex-shrink:0; width:clamp(70px,13vw,148px); height:100%; }',
    '.sp-qr { flex:1 1 0; border:1.5px dashed #ccc; border-radius:8px; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:clamp(4px,.7vw,8px); gap:clamp(2px,.4vw,5px); min-height:0; }',
...
var DZ_SCHILD_PRINT_CSS = [
    ...
    '.p-spruch { writing-mode:vertical-rl; transform:rotate(180deg); display:flex; align-items:center; justify-content:center; font-family:Georgia,serif; font-style:italic; font-size:9pt; color:#555; letter-spacing:.08em; padding-right:2mm; white-space:nowrap; flex-shrink:0; border-right:0.5pt solid #e0dbd4; margin-right:2mm; -webkit-print-color-adjust:exact; print-color-adjust:exact; }',
    '.p-right { display:flex; flex-direction:column; gap:2.5mm; width:46mm; }',
    '.p-nfc { flex:1 1 0; border:1pt dashed #ccc; border-radius:3pt; overflow:hidden; display:flex; flex-direction:row; min-height:0; }',
    ...
    '.p-qr { flex:1 1 0; border:1pt dashed #ccc; border-radius:3pt; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:2mm; gap:1.5mm; min-height:0; }',
