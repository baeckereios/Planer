...
var _active = { A: false, B: false, C: false, D: false, E: false, F: false, H: false, I: false };
var _locked = { B: false };
...
function _rerenderAllActive() {
    ['A','B','C','D','E','F','H','I'].forEach(function(id) {
        if (_active[id]) _rerender(id);
    });
}
...
function _collectPrintCSS() {
    ...
    var moduleCss = [
        ...
        typeof DZ_PRINT_CSS_H !== 'undefined' ? DZ_PRINT_CSS_H : '',
        typeof DZ_PRINT_CSS_I !== 'undefined' ? DZ_PRINT_CSS_I : ''
    ].join('\n');
...
function doPrint() {
    ...
    // ── Auto-Snapshot für Guten-Morgen-Seite (Modul J) ──────────────────
    if (_active['A'] && typeof DZ_J_snapshotA === 'function') DZ_J_snapshotA();
    if (_active['I'] && typeof DZ_J_snapshotI === 'function') DZ_J_snapshotI();
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof DZ_H_render === 'function') DZ_H_render();
    if (typeof DZ_I_render === 'function') DZ_I_render();
    if (typeof DZ_SCHILD_render === 'function') { DZ_SCHILD_render(); DZ_SCHILD_genQR('https://baeckereios.github.io'); }
