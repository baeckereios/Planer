...
(function() {
    'use strict';
        ...
        const PAGE_CONFIG = {
        'setup.html':                { title: 'Assistent',          mode: 'minimal'                  },
    ...
    const isSubfolder = window.location.href.includes('/baeko_bestellung/') || window.location.href.includes('/news_rohstoffe/') || window.location.href.includes('/azubi_meisterhaft/');
